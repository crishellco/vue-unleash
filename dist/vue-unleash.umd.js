/*!
 * vue-unleash v0.1.0 
 * (c) 2019 Chris Mitchell (@crishellco)
 * Released under the MIT License.
 */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('lodash'), require('isomorphic-fetch')) :
  typeof define === 'function' && define.amd ? define(['lodash', 'isomorphic-fetch'], factory) :
  (global = global || self, global.VueUnleash = factory(global.lodash, global.isomorphicFetch));
}(this, (function (lodash, isomorphicFetch) { 'use strict';

  isomorphicFetch = isomorphicFetch && isomorphicFetch.hasOwnProperty('default') ? isomorphicFetch['default'] : isomorphicFetch;
  ...
  var handleResponse$1 = handleResponse_1.handleResponse,
      handleError$2 = handleResponse_1.handleError;

  var zlFetch = function zlFetch(url, options) {
    var opts = createRequestOptions(Object.assign({
      url: url
    }, options));
    return fetch(opts.url, opts).then(handleResponse$1).catch(handleError$2);
  }; // ========================
  // Shorthands
  // ========================
  ...
  var moduleFactory = function moduleFactory(host, appName) {
    return {
      actions: {
        fetch: function fetch(_ref) {
          var commit, _ref2, body;

          return regenerator.async(function fetch$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  commit = _ref.commit;
                  _context.next = 3;
                  return regenerator.awrap(src("".concat(host, "/api/client/features"), {
                    headers: {
                ...
                case 3:
                  _ref2 = _context.sent;
                  body = _ref2.body;
                  commit("setFeatures", lodash.mapValues(lodash.keyBy(body.features, "name"), "enabled"));
      ...
      mutations: {
        setFeatures: function setFeatures(state, features) {
  ...
  /* template */
    ...
    var Feature = normalizeComponent_1(
      {},
